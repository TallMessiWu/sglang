...
class NPUW4A8DynamicLinearMethod(_NPULinearMethodBase):
    ...
    Uses ``torch.ops.npu.npu_weight_quant_batchmatmul`` for inference —
    activations stay in high precision and INT4 weights are dequantized
    on-the-fly.
    """
    ...
    def apply(
        ...
        # Weight-dequant path: INT4 weights dequantized on-the-fly, activations
